...
@interface ZRSpeakerVolume ()

@property (nonatomic, strong) CMMotionManager *motionManager;

@end

@implementation ZRSpeakerVolume
...
-(void)setup
{
    [self setMinimumTrackImage:[[UIImage imageNamed:@"progress"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 4, 0, 0)] forState:UIControlStateNormal];
    [self setMaximumTrackImage:[[UIImage imageNamed:@"bar"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 4)] forState:UIControlStateNormal];
